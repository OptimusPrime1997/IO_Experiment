...
sudo /home/ljh/projects/spdk/app/vhost/vhost -S /var/ljh/mem -r /var/ljh/sock/vhost01.sock -s $((1024*$N))  -m 0x5 -c  /home/ljh/projects/spdk/etc/spdk/vhost.conf.02.in_blk2 &

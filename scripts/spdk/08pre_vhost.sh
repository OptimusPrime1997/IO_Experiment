...
SIZE=$((1024*28))
sudo HUGEMEM=$SIZE /home/ljh/projects/spdk/scripts/setup.sh
sudo /home/ljh/projects/spdk/app/vhost/vhost -S /var/ljh/mem -r /var/ljh/sock/vhost08.sock -s 2048 -c /home/ljh/projects/spdk/etc/spdk/vhost.conf.08.in &

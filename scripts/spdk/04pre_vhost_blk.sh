...
sudo /home/ljh/projects/spdk/app/vhost/vhost -S /var/ljh/mem -r /var/ljh/sock/vhost04.sock -s $((1024*4))  -m 0x55 -c /home/ljh/projects/spdk/etc/spdk/vhost.conf.04.in_blk &

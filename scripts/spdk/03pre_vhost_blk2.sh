...
sudo /home/ljh/projects/spdk/app/vhost/vhost -S /var/ljh/mem -r /var/ljh/sock/vhost0"$N".sock -s $((1024*$N))  -m 0x15 -c /home/ljh/projects/spdk/etc/spdk/vhost.conf.0"$N".in_blk2 &
